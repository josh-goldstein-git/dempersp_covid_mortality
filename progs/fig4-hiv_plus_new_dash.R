################################################ 
# Epidemic Death Comparison (Figure 4)
################################################ 

# We plot the mortality of the Covid-19 scenario compared to past US 
# epidemics: (1) Spanish Flu, (2) HIV, and (3) Opioids. We compare 
# epidemic deaths, epidemic deahts / population size, and life years 
# lots, relative to non-epidemic mortality 
